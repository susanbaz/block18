...
function default_1($) {
    $.knownAtRule = $.OVERRIDE_RULE('knownAtRule', () => $.OR([
        { ALT: () => $.SUBRULE($.mixin) },
    ...
    $.atImportCss = $.RULE('atImportCss', () => $.OR([
    ...
    $.atImportJs = $.RULE('atImportJs', () => {
        ...
        $.OR([
            {
                ALT: () => {
                    children.push($.CONSUME($.T.Star), $._(), $.CONSUME($.T.As), $._(1), 
                    /** JS ident */
                    $.CONSUME($.T.Ident));
                }
            },
            {
                ALT: () => {
                    /** JS ident */
                    children.push($.CONSUME2($.T.Ident), $._(2));
                    $.OPTION(() => {
                        children.push($.CONSUME($.T.Comma), $._(3), $.SUBRULE($.atImportJsBlock));
                    });
                }
            },
            {
        ...
        children.push($._(4), $.CONSUME($.T.From), $._(5), $.CONSUME($.T.StringLiteral));
        return {
            name: 'atImportJs',
            children
        };
    ...
    $.atImportJsArg = $.RULE('atImportJsArg', () => {
        ...
        $.OPTION(() => {
            children.push($.CONSUME($.T.As), $._(1), 
            /** JS ident */
            $.CONSUME2($.T.PlainIdent), $._(2));
        });
        return {
            name: 'atImportJsArg',
            children
